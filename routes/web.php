...
Route::get('/clientes', [ClienteController::class, 'show'])->middleware('auth')->middleware('auth')->name('clientes');
Route::put('/clientes/{id}', [ClienteController::class, 'update'])->name('clientes.update');
Route::delete('/clientes/{id}', [ClienteController::class, 'destroy'])->name('clientes.destroy');
Route::post('/clientes', [ClienteController::class, 'store'])->name('clientes.store');

// Ruta para mostrar las vista servicios
Route::get('/servicios', [ServicioController::class, 'index'])->middleware('auth')->name('servicios');
...
Route::get('/pagos', [PagoController::class, 'index'])->middleware('auth')->name('pagos');
...
Route::get('/bases', [BaseController::class, 'index'])->middleware('auth')->name('bases');
...
Route::get('/tickets', [TicketController::class, 'index'])->middleware('auth')->name('tickets');
